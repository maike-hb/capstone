...
wp core install --url=${props["WP_URL"]} --title=${props["WP_TITLE"]} --admin_user=${props["WP_ADMIN_USER_NAME"]} --admin_email=${props["WP_ADMIN_EMAIL"]} --admin_password=${props["WP_ADMIN_USER_PASS"]}
